    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview" style="display: none;">
            <li class="nav-item">
              <a <?php if(isset($update_food_category)){ echo 'href="'.$act_link.'"'; } else{ ?> href="<?php echo base_url(); ?>Master/food_category" <?php } ?> class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Food Category</p>
              </a>
            </li>
            <li class="nav-item">
              <a <?php if(isset($update_food)){ echo 'href="'.$act_link.'"'; } else{ ?> href="<?php echo base_url(); ?>Master/food" <?php } ?> class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Food</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview" style="display: none;">
            <li class="nav-item">
              <a <?php if(isset($update_tax_rate)){ echo 'href="'.$act_link.'"'; } else{ ?> href="<?php echo base_url(); ?>Master/tax_rate" <?php } ?> class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Tax Rate</p>
              </a>
            </li>
            <li class="nav-item">
              <a <?php if(isset($update_shipping_method)){ echo 'href="'.$act_link.'"'; } else{ ?> href="<?php echo base_url(); ?>Master/shipping_method" <?php } ?> class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Shipping Method</p>
              </a>
            </li>
