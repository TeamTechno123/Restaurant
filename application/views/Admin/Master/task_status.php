                  ...
                  <div class="card-footer clearfix" style="display: block;">
                    <div class="row">
                      ...
                      <div class="col-md-6 text-right">
                        <a href="<?php base_url(); ?>Master/task_status" class="btn btn-sm btn-default px-4 mx-4">Cancel</a>
                        <?php if(isset($update)){
                  ...
                  <tbody>
                    ...
                    $i=0; foreach ($task_status_list as $list) { $i++; ?>
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="<?php echo base_url() ?>Master/edit_task_status/<?php echo $list->task_status_id; ?>" type="button" class="btn btn-sm btn-default"><i class="fa fa-edit text-primary"></i></a>
                            <a href="<?php echo base_url() ?>Master/delete_task_status/<?php echo $list->task_status_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Task Status');"><i class="fa fa-trash text-danger"></i></a>
                          </div>
                        </td>
